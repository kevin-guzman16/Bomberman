class Nivel_III extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('enemigos', 'bomberman/assets/nivel_3/imgs/enemigoIII.png', { frameWidth: 22, frameHeight: 29});
        this.load.spritesheet('bomba', 'bomberman/assets/nivel_3/imgs/bomba.png', { frameWidth: 16, frameHeight: 16 });
        this.load.spritesheet('explosion', 'bomberman/assets/imgs/explosion.png', { frameWidth: 48, frameHeight: 48 });
        this.load.spritesheet('bloqueRoto', 'bomberman/assets/nivel_3/imgs/bloque_anim.png', { frameWidth: 16, frameHeight: 16});
        this.load.spritesheet('puerta', 'bomberman/assets/nivel_3/imgs/puerta.png', { frameWidth: 28, frameHeight: 16 });

        this.load.tilemapTiledJSON('mapa', 'bomberman/assets/nivel_3/mapa.json');

        this.load.image('tiles', 'bomberman/assets/nivel_3/imgs/tileset_3.png');
        this.load.image('bloques', 'bomberman/assets/nivel_3/imgs/bloque.png');
        this.load.image('marcador', 'bomberman/assets/imgs/marcador.png');

        this.load.audio('fondo', ['bomberman/assets/nivel_3/audios/fondo.mp3']);
        ...
        this.load.audio('ganarSound', ['bomberman/assets/nivel_3/audios/ganar.mp3'])
    ...
    create ()
    {
        ...
        let tilesets = this.mapa.addTilesetImage('tileset_3', 'tiles');
    ...
    irSiguienteNivel(){
        ...
        if(!self.pasarNivel){
            ...
            temporizador = setInterval(function(){
                ...
                if(contador == 6){
                    self.scene.add("Victoria", new Victoria);
                    self.scene.start("Victoria");
                    self.limpiarCache();
    ...
    update ()
    {
        ...
        if(!this.quitarVida){
            ...
            if(self.ponerBomba.isDown && bomba == undefined){
                this.crearBomba();
            }
