class Nivel_III extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('enemigos', 'assets/nivel_3/imgs/enemigoIII.png', { frameWidth: 22, frameHeight: 29});
        this.load.spritesheet('bomba', 'assets/nivel_3/imgs/bomba.png', { frameWidth: 16, frameHeight: 16 });
        this.load.spritesheet('explosion', 'assets/imgs/explosion.png', { frameWidth: 48, frameHeight: 48 });
        this.load.spritesheet('bloqueRoto', 'assets/nivel_3/imgs/bloque_anim.png', { frameWidth: 16, frameHeight: 16});
        this.load.spritesheet('puerta', 'assets/nivel_3/imgs/puerta.png', { frameWidth: 28, frameHeight: 16 });

        this.load.tilemapTiledJSON('mapa', 'assets/nivel_3/mapa.json');

        this.load.image('tiles', 'assets/nivel_3/imgs/tileset_3.png');
        this.load.image('bloques', 'assets/nivel_3/imgs/bloque.png');
        this.load.image('marcador', 'assets/imgs/marcador.png');

        this.load.audio('fondo', ['assets/nivel_3/audios/fondo.mp3']);
        this.load.audio('explosionSound', ['assets/audios/explosion.wav']);
        this.load.audio('ponerBombaSound', ['assets/audios/ponerBomba.wav']);
        this.load.audio('ganarSound', ['assets/nivel_3/audios/ganar.mp3'])
