class Nivel_II extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('enemigos', 'bomberman/assets/nivel_2/imgs/enemigo.png', { frameWidth: 22, frameHeight: 36});
        this.load.spritesheet('bomba', 'bomberman/assets/nivel_2/imgs/bomba.png', { frameWidth: 20.5, frameHeight: 20.8 });
        this.load.spritesheet('explosion', 'bomberman/assets/imgs/explosion.png', { frameWidth: 48, frameHeight: 48 });
        this.load.spritesheet('bloqueRoto', 'bomberman/assets/nivel_2/imgs/bloque_anim_II.png', { frameWidth: 16, frameHeight: 16});
        this.load.spritesheet('puerta', 'bomberman/assets/nivel_2/imgs/puerta.png', { frameWidth: 32, frameHeight: 22 });

        this.load.tilemapTiledJSON('mapa', 'bomberman/assets/nivel_2/mapa.json');

        this.load.image('tiles', 'bomberman/assets/nivel_2/imgs/tileset_1.png');
        this.load.image('bloques', 'bomberman/assets/nivel_2/imgs/bloque.png');
        this.load.image('marcador', 'bomberman/assets/imgs/marcador.png');

        this.load.audio('fondo', ['bomberman/assets/nivel_2/audios/fondo.mp3']);
        ...
        this.load.audio('ganarSound', ['bomberman/assets/nivel_2/audios/ganar.mp3']);
    ...
    create ()
    {
        ...
        let tilesets = this.mapa.addTilesetImage('tileset_II', 'tiles');
        ...
        let empezarX = posicionJugador[0].x+8;
        let empezarY = posicionJugador[0].y+3;
        ...
        this.input.keyboard.on('keydown-P', function(pointer) {
            this.scene.remove('pausaNivel_II');
            this.scene.add("pausaNivel_II", new pausaNivel_II);
            this.scene.launch('pausaNivel_II');
            this.scene.pause('Nivel_II');
            musica_fondo.pause();
        }, this);
    ...
    formatTime(segundos){
        ...
        var partInSegundos = segundos%60;
        partInSegundos = partInSegundos.toString().padStart(2,'0');

        return `${minutos}:${partInSegundos}`;
    }
    ...
    explotarBomba(bomba){
        ...
        alcance_derecha.setImmovable(true);
        ...
        expFinal_derecha.setImmovable(true);
        ...
        alcance_izquierda.setImmovable(true);
        ...
        expFinal_izquierda.setImmovable(true);
        ...
        alcance_arriba.setImmovable(true);
        ...
        expFinal_arriba.setImmovable(true);
        ...
        alcance_abajo.setImmovable(true);
        ...
        expFinal_abajo.setImmovable(true);

        //colision con bloques solidos
        ...
        //Colision del enemigo sobre la explosion
    ...
    irSiguienteNivel(){
        ...
        if(!self.pasarNivel){
            ...
            temporizador = setInterval(function(){
                ...
                if(contador == 5){
                    self.scene.add("PNivel3", new PNivel3);
