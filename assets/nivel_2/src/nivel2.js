class Nivel_II extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.spritesheet('enemigos', 'assets/nivel_2/imgs/enemigo.png', { frameWidth: 22, frameHeight: 36});
        this.load.spritesheet('bomba', 'assets/nivel_2/imgs/bomba.png', { frameWidth: 20.5, frameHeight: 20.8 });
        this.load.spritesheet('explosion', 'assets/imgs/explosion.png', { frameWidth: 48, frameHeight: 48 });
        this.load.spritesheet('bloqueRoto', 'assets/nivel_2/imgs/bloque_anim_II.png', { frameWidth: 16, frameHeight: 16});
        this.load.spritesheet('puerta', 'assets/nivel_2/imgs/puerta.png', { frameWidth: 32, frameHeight: 22 });

        this.load.tilemapTiledJSON('mapa', 'assets/nivel_2/mapa.json');

        this.load.image('tiles', 'assets/nivel_2/imgs/tileset_1.png');
        this.load.image('bloques', 'assets/nivel_2/imgs/bloque.png');
        this.load.image('marcador', 'assets/imgs/marcador.png');

        this.load.audio('fondo', ['assets/nivel_2/audios/fondo.mp3']);
        this.load.audio('explosionSound', ['assets/audios/explosion.wav']);
        this.load.audio('ponerBombaSound', ['assets/audios/ponerBomba.wav']);
        this.load.audio('ganarSound', ['assets/nivel_2/audios/ganar.mp3']);
